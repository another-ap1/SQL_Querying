--SCHEMA analytics(id, app_name, category, rating, reviews, size, min_installs, price, content_rating, genres, last_updated, current_version, android_version)
...
SELECT COUNT(rating) FROM analytics WHERE rating > 0;
